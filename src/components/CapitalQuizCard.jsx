...
const CapitalQuizCard = ({ countriesList }) => {
  ...
  const generateAnswers = (idx) => {
    const answersArray = [];
    answersArray.push(countries[idx].capital);
  ...
  return (
    <>
      <div className="flex items-center justify-between  my-8 bg-gradient-to-b from-yellow-500 via-yellow-300 to-yellow-500 px-3 pt-1 pb-[6px]  w-full  text-sm rounded-full tracking-wide font-semibold shadow-md uppercase">
      ...
      <div className="grid sm:grid-cols-2 gap-4 ">
        <div className="">
          {index === -2 ? (
            ...
            <div>
              <h3 className="text-center sm:text-left text-3xl mb-3 uppercase tracking-wide">
                {countries[index].name.common}
              </h3>
              <img
                className=" h-28 sm:h-full sm:max-h-40 mx-auto sm:ml-0 sm:mb-2 "
        ...
        <div className="grid grid-cols-2 grid-rows-2 gap-6 sm:gap-4 text-center p-2  ">
          {answers.map((answer) => {
            let rightAnswer = countries[index].capital;
      ...
      <div className="flex mt-8 justify-center">
        {isSelected && (
          <button
            ...
            className=" bg-gradient-to-b from-yellow-500 via-yellow-300 to-yellow-500 px-3 pt-1 pb-[3px]  w-full  text-slate-700 rounded-full tracking-wider font-bold shadow-md uppercase disabled:bg-gray-300 transition duration-200 hover:scale-105 "
          >
            Next
          </button>
        )}
